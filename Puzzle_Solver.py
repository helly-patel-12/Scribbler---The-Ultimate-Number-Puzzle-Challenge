...
w_of_board = 3  # total number of columns in the board of Puzzle Game In Python
h_of_board = 3  # total number of rows in the board
block_size = 80
win_width = 800
win_height = 600
FPS = 30
...
def main():
    ...
    while True:
        ...
        if mainBoard == SOLVEDBOARD:
            msg = 'Brilliant!! Your puzzle is Solved!'
